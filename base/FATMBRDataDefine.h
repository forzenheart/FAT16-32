#ifndef	__FAT_MBR_DATA_DEFINE_H__
#define	__FAT_MBR_DATA_DEFINE_H__
/*
 *fat文件系统基本数据结构的定义
 */
/*
...
#define	BPB_BytsPerClus	0xD	//1	//每簇扇区数, 其值必须是2的整数次方(该整数必须>=0)
					//还必须保证每簇的字节数不超过32K, 即:
					//(BPB_BytsPerSec * BPB_BytsPerClus <= 32K(1024*32))

#define	BPB_RsvdSecCnt	0xE	//2	//保留区中保留扇区的数目, 保留扇区从FAT第一个扇区开始
...
#endif // __FAT_MBR_DATA_DEFINE_H__
